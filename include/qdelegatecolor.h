...
#ifndef Q_DELEGATE_COLOR_H
#define Q_DELEGATE_COLOR_H

#include <QStyledItemDelegate>
#include <QPainter>
#include <QTextDocument>

class QDelegateColor : public QStyledItemDelegate
{
	Q_OBJECT
public:
	QDelegateColor(QObject *parent = NULL) :QStyledItemDelegate(parent) {
